...
#this gives likelyhood someone is active. 
...
#first 10 elements of the in_sample data that satisfy the purchase requirement. 
head(in_sample[z,], 10)
...
#calculates how much they will spend if they are active. 
